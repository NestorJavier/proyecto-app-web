...
<div>
    <div class="container" style="margin-top:5vh;">
        <div class="row">
            ...
            <div class="col-8 col-md-3" style="margin">
                <h6 style="visibility: hidden;">con</h6>
                <button class="btn btn-primary" onclick="guardaCarrera(this)">Confirmar Carrera</button>
            </div>
            <div class="col-8 col-md-6" style="margin">
                <h6>Registra tus materias ya aprobadas</h6>
                <button class="btn btn-primary" id="btnRegistraMaterias" disabled="true" onclick="guardaMaterias()" >Registrar</button>
            </div>
        </div>
    </div>
...
let carrera_seleccionada_id = 16; //Es el valor por default
...
function guardaCarrera(obj){
    if(carrera_seleccionada_id != 16){
        console.log(carrera_seleccionada_id);
        let data = { idCarrera: carrera_seleccionada_id };
        let url = "{{ url('usuario') }}" + "/" + "{{Auth::user()->id}}";
        console.log(url);
        ...
        .then(data => {
            ...
            document.getElementById("selectCareerControl").disabled = true;
            document.getElementById("btnRegistraMaterias").disabled = false;
            obj.disabled = true;
        })
        .catch((error) => {
